...
# Extra functions added to the original 'scikits.bootsgrap' module
# Fernando Paolo <fpaolo@ucsd.edu>
# Feb 26, 2015

def it_moving_blocks(nobs, block_length, truncate=True):
...
def bootstrap_indexes_mblocks(x, n_samples=10, block_lenght=3, truncate=True):
    nobs = x.shape[0]
    idx = np.arange(nobs)
    iter_obj = it_moving_blocks(nobs, block_lenght, truncate)
